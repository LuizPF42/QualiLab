...
4. Confira o **monitor de rede**: zero requisições. Duvida do monitor? Ele mesmo sugere os auditores externos: **F12 → aba Rede**, ou desligar o Wi-Fi e seguir trabalhando. O botão **⚡** manda a página *tentar* acessar a internet, para você ver o navegador barrar.
