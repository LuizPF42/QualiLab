...
Ao criar um projeto (rascunho, arquivo ou nuvem), o QualiLab pergunta se ele terá **recursos de IA**: **Sem IA** (o padrão, e as telas de IA não aparecem) ou **Ativar IA**. Dá para mudar depois ([17.7](#177-desligar-a-ia-neste-projeto)).
...
> As três telas de **IA** são **opt-in**: com a IA desativada no projeto (o padrão), elas não aparecem, inclusive a Repetir Codificação, que não usa IA. Também não aparecem para quem tem papel de somente leitura. Detalhes na [seção 17](#17-codificar-e-analisar-com-ia).
...
Além desta chave, as telas de IA nunca aparecem para quem tem papel **somente leitura**, e a [matriz de papéis](#o-que-cada-papel-pode-fazer-decidido-na-criação) (*Usa os painéis de IA*) pode tirá-las de membros mesmo com a IA ativada.
