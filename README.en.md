...
| **Audit trail of the process** | 7 | ❌ not yet |
...
- **No audit trail of the process.** There is no log of project operations, and **Ctrl+Z** undoes only the session's last coding. Deleting a document, code or attribute is final. It is the criterion where QualiLab sits below the field's median, in the yardstick above.
